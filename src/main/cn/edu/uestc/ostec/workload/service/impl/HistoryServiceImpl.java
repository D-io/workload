...
public class HistoryServiceImpl extends BaseServiceImpl implements HistoryService {
	...
	public History getHistory(Integer historyId, String version) {
		return objectResult(historyDao.selectHistories(historyId, null, null, null, version),
				EMPTY_HISTORY);
	}
	...
	@Override
	public List<History> getResetHistories(Integer userId, String version) {
		return listResult(historyDao.selectResetItemHistory(userId, version));
	}
