...
<div class="x_panel" style="width: 100%;padding: 10px 17px;">
    ...
    <div class="x_content">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
            <span class="spanTitle" style="margin-left: 30%;">工作当量导入</span><hr/>
            <a type="button" class="btn btn-default" aria-label="Left Align" onclick="importWorkload()" style="border: 0px;margin-left: 30%;">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
            <span class="spanTitle" style="margin-left: 30%;">工作当量审核</span><hr/>
            <a type="button" class="btn btn-default" aria-label="Left Align" onclick="auditworkload()" style="border: 0px;margin-left: 30%;">
