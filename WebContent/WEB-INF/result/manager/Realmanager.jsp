        ...
        <div class="col-md-3 left_col menu_fixed" id="left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title">
                    <a href="#" class="site_title"><span><img src="css/images/logo.png" alt="..." class="left_span"></span><span class="right_span">教学工作量计算系统</span></a>
                    ...
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            ...
                            <li class="active"><a id="clickToggle2"><i class="fa fa-edit"></i> 重置 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: block;">
                                    <li class="ck2" onclick="reset()"><a><span>权限重置</span></a></li>
                                </ul>
                            </li>
